...
public class SetTests {
	...
	public void MandelbrotXAxis() {
		...
		assertEquals(0, ma.createMandel()[372][0], 0);
	}
	@Test
	public void JuliaXAxis() {
		Julia j = new Julia();
		assertEquals(0, j.createJulia()[372][0], 0);
	}
	@Test
	public void BurningShipXAxis() {
		BurningShip bs = new BurningShip();
		assertEquals(0, bs.createBS()[372][0], 0);
	}
	@Test
	...
	public void MandelbrotYAxis() {
		Mandelbrot ma = new Mandelbrot();
		assertEquals(0, ma.createMandel()[0][393], 0);	
	}
	@Test
	...
	public void MultibrotYAxis() {
		Multibrot mu = new Multibrot();
		assertEquals(0, mu.createMulti()[0][393], 0);
	}
	...
	@Test
	  public final void MandelbrotNeverExceedsEscapeDistance() {
		Mandelbrot ma = new Mandelbrot();
	    assertEquals(255, ma.escapeTime(0.3207031250000001, -0.07109374999999386), 0.001);
	  }
	@Test
	  public final void JuliaNeverExceedsEscapeDistance() {
	    Julia j = new Julia();
	    assertEquals(255, j.escapeTime(1.0492187499999897, -0.234375), 0.001);
	  }
	@Test
	  public final void BurningShipNeverExceedsEscapeDistance() {
	    BurningShip bs = new BurningShip();
	    assertEquals(255, bs.escapeTime(-1.7443359374999874, -0.017451171875000338), 0.001);
	  }
	@Test
	  public final void MultibrotNeverExceedsEscapeDistance() {
		Multibrot mu = new Multibrot();
	    assertEquals(255, mu.escapeTime(0.5859375, 0.24375000000000108), 0.001);
	  }
	...
	@Test
	  public final void MandelbrotExceedsExcapeDistanceAfterOneLoop() {
		Mandelbrot ma = new Mandelbrot();
	    assertEquals(1, ma.escapeTime(0.5946289062500001, 1.2949218750000122), 0.001);
	  }
	@Test
	  public final void JuliaExceedsExcapeDistanceAfterOneLoop() {
	    Julia j = new Julia();
	    assertEquals(1, j.escapeTime(1.6933593749999853, 0.9765625), 0.001);
	  }
	@Test
	  public final void MultibrotExceedsExcapeDistanceAfterOneLoop() {
		Multibrot mu = new Multibrot();
	    assertEquals(1, mu.escapeTime(0.9921875, 1.05625), 0.001);
	}
