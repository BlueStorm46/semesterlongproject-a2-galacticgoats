...
public class PhaseOneTests {
	...
	public void MandelbrotXAxis() {
		...
		assertEquals(0, ma.createMandel(-2.15, 0.6, -1.3, 1.3, 2, 255, 4)[206][0], 0);
	}
	@Test
	public void JuliaXAxis() {
		Julia j = new Julia();
		assertEquals(1, j.createJulia(-1.7, 1.7, -1.0, 1.0, 2, 255, 4)[206][0], 0);
	}
	@Test
	public void BurningShipXAxis() {
		BurningShip bs = new BurningShip();
		assertEquals(3, bs.createBS(-1.8, -1.7, -0.08, 0.025, 2, 255, 4)[206][0], 0);
	}
	@Test
	public void MultibrotXAxis() {
		Multibrot mu = new Multibrot();
		assertEquals(1, mu.createMulti(-1, 1, -1.3, 1.3, 2, 255, 4)[206][0], 0);
	}
	...
	public void MandelbrotYAxis() {
		Mandelbrot ma = new Mandelbrot();
		assertEquals(0, ma.createMandel(-2.15, 0.6, -1.3, 1.3, 2, 255, 4)[0][206], 0);	
	}
	@Test
	public void JuliaYAxis() {
		Julia j = new Julia();
		assertEquals(1, j.createJulia(-1.7, 1.7, -1.0, 1.0, 2, 255, 4)[0][206], 0);
	}
	@Test
	public void BurningShipYAxis() {
		BurningShip bs = new BurningShip();
		assertEquals(7, bs.createBS(-1.8, -1.7, -0.08, 0.025, 2, 255, 4)[0][206], 0);
	}
	@Test
	public void MultibrotYAxis() {
		Multibrot mu = new Multibrot();
		assertEquals(1, mu.createMulti(-1, 1, -1.3, 1.3, 2, 255, 4)[0][206], 0);
	}
	...
	public void MandelbrotFractalSize() { 
		Mandelbrot ma = new Mandelbrot();
		assertEquals(2048, ma.createMandel(-2.15, 0.6, -1.3, 1.3, 2, 255, 4).length, 0);
	}
	@Test
	public void JuliaFractalSize() {
		Julia j = new Julia();
		assertEquals(2048, j.createJulia(-1.7, 1.7, -1.0, 1.0, 2, 255, 4).length, 0);
	}
	@Test
	public void BurningShipFractalSize() {
		BurningShip bs = new BurningShip();
		assertEquals(2048, bs.createBS(-1.8, -1.7, -0.08, 0.025, 2, 255, 4).length, 0);
	}
	@Test
	public void MultibrotFractalSize() { 
		Multibrot mu = new Multibrot();
		assertEquals(2048, mu.createMulti(-1, 1, -1.3, 1.3, 2, 255, 4).length, 0);
	}
}