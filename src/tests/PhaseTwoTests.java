...
public class PhaseTwoTests {
	...
	@Test
	  public final void MandelbrotTenLoopPasses() {
	    ...
	    assertEquals(10, ma.escapeTime(0.46007827788650374, -0.33835616438356616, 3), 0.001);
	  }
	@Test
	  public final void JuliaTenLoopPasses() {
	    Julia j = new Julia();
	    assertEquals(10, j.escapeTime(1.4538160469667272, -0.13502935420743645, 3), 0.001);
	  }
	@Test
	  public final void BurningShipTenLoopPasses() {
	    BurningShip bs = new BurningShip();
	    assertEquals(10, bs.escapeTime(-1.6999999999999802, 0.0030136986301371603, 3), 0.001);
	  }
	@Test
