...
public class JuliaTest {
	...
	public void test() {
		...
		assertEquals(4, juliaSet.escapetime(1.0492187499999897, -0.234375), 0);
	}
	...
	public void test2() {
		...
		assertEquals(255, juliaSet.escapetime(1.6933593749999853, 0.9765625), 0);
	}
	...
	public void testyaxis() {
		Julia juliaSet = new Julia();
		assertEquals(0, juliaSet.createJulia()[0][393], 0);
	}
