...
public class Multibrot {
	...
	public int escapeTime(double xCalc, double yCalc, double escapeDistance, int escapeTime, int threads) {
	...
	public int[][] createMulti(double x_min, double x_max, double y_min, double y_max, double escapeDistance, int escapeTime, int threads) {
